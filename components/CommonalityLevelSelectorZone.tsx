        ...
        <Card className="h-full flex flex-col">
            ...
            {levels.length > 0 ? (
                ...
                <div className="text-center py-10 flex-grow flex flex-col items-center justify-center">
                    <p className="text-lg font-semibold text-stone-600 dark:text-stone-300">No Words Found</p>
                    <p className="text-stone-500 dark:text-stone-400 mt-1">Vocabulary data could not be loaded.</p>
                </div>
            )}
        </Card>
    );

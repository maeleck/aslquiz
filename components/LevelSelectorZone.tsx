        ...
        <Card className="h-full flex flex-col">
            ...
            {levels.length > 0 ? (
                ...
                <div className="text-center py-10 flex-grow flex flex-col items-center justify-center">
                    <p className="text-lg font-semibold text-slate-600 dark:text-slate-300">Coming Soon!</p>
                    <p className="text-slate-500 dark:text-slate-400 mt-1">Levels for "{topic.label}" will be added in a future update.</p>
                </div>
            )}
        </Card>
    );

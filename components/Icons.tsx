...
export const CurrencyDollarIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-green-600 dark:text-green-400" viewBox="0 0 20 20" fill="currentColor">
        <path d="M8.433 7.418c.158-.103.346-.196.567-.267v1.698a2.305 2.305 0 01-.567-.267C8.07 8.34 8 8.114 8 8c0-.114.07-.34.433-.582zM11 12.849v-1.698c.22.071.41.164.567.267.364.24.433.466.433.582 0 .114-.07.34-.433.582a2.305 2.305 0 01-.567.267z" />
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-13a1 1 0 10-2 0v.092a4.535 4.535 0 00-1.876.662C6.168 6.258 6 6.635 6 7c0 .364.168.742.876 1.124.708.382 1.876.662 1.876 1.376 0 .714-1.168 1.002-1.876 1.384C6.168 11.258 6 11.635 6 12c0 .364.168.742.876 1.124.708.382 1.876.662 1.876 1.376 0 .714-1.168 1.002-1.876 1.384C6.168 15.258 6 15.635 6 16c0 .534.468.627 1.18.733.22.033.453.05.694.055a1 1 0 001.007-.923 4.535 4.535 0 001.876-.662C13.832 14.742 14 14.365 14 14c0-.364-.168-.742-.876-1.124-.708-.382-1.876-.662-1.876-1.376 0-.714 1.168-1.002 1.876-1.384.708-.382.876-.75.876-1.124 0-.364-.168-.742-.876-1.124-.708-.382-1.876-.662-1.876-1.376 0-.714 1.168-1.002 1.876-1.384C13.832 5.742 14 5.365 14 5c0-.534-.468-.627-1.18-.733A5.61 5.61 0 0011 4.092V4a1 1 0 10-2 0v1z" clipRule="evenodd" />
    </svg>
);
...
export const BriefcaseIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.964 2.5-2.25 2.5h-10.5c-1.286 0-2.25-.937-2.25-2.25V14.15M16.5 6.75h-9v4.5h9v-4.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 6.75V4.5a2.25 2.25 0 012.25-2.25h.01a2.25 2.25 0 012.25 2.25v2.25" />
    </svg>
);
...
export const ShoppingCartIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.838-5.514a1.875 1.875 0 00-1.087-2.336H6.14M15 15.75a3 3 0 01-3-3m0 0a3 3 0 00-3 3m3-3V7.5M9 15.75a3 3 0 00-3-3m0 0a3 3 0 01-3-3m3 3V7.5m6 8.25v-5.514M12 15.75a3 3 0 01-3-3m3 3a3 3 0 00-3-3m3 3V7.5" />
    </svg>
);
...
import { ALPHABET_DICTIONARY, WORD_DICTIONARY, ASL_CULTURE_QUOTES } from '../constants';
...
type DictionaryTab = 'words' | 'alphabet' | 'collectibles';

export const DictionaryZone: React.FC<DictionaryZoneProps> = (props) => {
  const [searchTerm, setSearchTerm] = useState('');
  const [activeTab, setActiveTab] = useState<DictionaryTab>('collectibles');
  ...
  return (
    <Card className="h-full flex flex-col min-h-[400px]">
      ...
      <div className="border-b border-stone-200 dark:border-stone-700 mb-6">
        <nav className="flex flex-wrap justify-center gap-x-4" aria-label="Dictionary categories">
      ...
      {activeTab === 'collectibles' ? <CollectiblesZone {...props} /> : renderDictionaryContent()}
